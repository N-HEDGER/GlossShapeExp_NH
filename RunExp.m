...
% Last Modified by GUIDE v2.5 22-Nov-2016 11:21:37
...
handles.subnote = get(handles.subnote,'String');
handles.isfixed = get(handles.isfixed,'Value') == get(handles.isfixed,'Max');
handles.isbinocular=get(handles.BINOC,'Value') == get(handles.BINOC,'Max');
handles.ismonocular=get(handles.MONOC,'Value') == get(handles.MONOC,'Max');
guidata(hObject, handles);
uiresume(handles.figure1);
 handles;
...
% --- Executes on button press in BINOC.
function BINOC_Callback(hObject, eventdata, handles)
% hObject    handle to BINOC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of BINOC


% --- Executes on button press in MONOC.
function MONOC_Callback(hObject, eventdata, handles)
% hObject    handle to MONOC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of MONOC
